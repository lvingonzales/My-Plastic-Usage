...
function App() {
  ...
  const [card, cardVisible] = useElementOnScreen({...options, threshold: 0.25 });
    ...
    <div style={{ position: "relative" }}>
      ...
      <div className="foreground-wrapper">
        ...
        <Card reference={card} focus={"hammer"}>
          <p>
            <em
              style={{ color: `var(--blue-color)`, fontSize: `2.5rem`}}
            >
              Work
            </em>{" "}
            had the highest number of individual plastic items at{" "}
            <em style={{ color: `var(--blue-color)`, fontSize: `2.25rem` }}>19 out of 57</em>{" "}
            accounting for some <em style={{ color: `var(--blue-color)`, fontSize: `2.25rem`}}>34%</em>{" "}
            of the total. These plastics mainly included{" "}
            <em>High Density Polyethylene</em> or HDPE, a common food safe
